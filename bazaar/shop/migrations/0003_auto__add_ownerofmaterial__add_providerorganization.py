...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ownerOfMaterial'
        db.create_table(u'shop_ownerofmaterial', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('itemId', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.MaterialItem'])),
            ('organizationId', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.ProviderOrganization'])),
        ))
        db.send_create_signal(u'shop', ['ownerOfMaterial'])

        # Adding model 'ProviderOrganization'
        db.create_table(u'shop_providerorganization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('organizationName', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('ownerUser', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'shop', ['ProviderOrganization'])


    def backwards(self, orm):
        # Deleting model 'ownerOfMaterial'
        db.delete_table(u'shop_ownerofmaterial')

        # Deleting model 'ProviderOrganization'
        db.delete_table(u'shop_providerorganization')
    ...
    models = {
        ...
        u'shop.ownerofmaterial': {
            'Meta': {'object_name': 'ownerOfMaterial'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'itemId': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shop.MaterialItem']"}),
            'organizationId': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shop.ProviderOrganization']"})
        },
        u'shop.providerorganization': {
            'Meta': {'object_name': 'ProviderOrganization'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organizationName': ('django.db.models.fields.CharField', [], {'max_length': '2000'}),
            'ownerUser': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'shop.ratings': {
